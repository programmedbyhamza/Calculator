...
public final class NNCalcView1 extends JFrame implements NNCalcView {
    ...
    public NNCalcView1() {
        ...
        for (Integer i = 0; i < DIGIT_BUTTONS; i++) {

            this.bDigits[i] = new JButton(i.toString());
        }
    ...
    public void updateTopDisplay(NaturalNumber n) {
        ...
        /*
         * setText updates tTop based on what n is which gets converted to a
    ...
    public void updateBottomDisplay(NaturalNumber n) {
        ...
        /*
         * setText updates tBottom based on what n is which gets converted to a
         * String in the argument
         */
